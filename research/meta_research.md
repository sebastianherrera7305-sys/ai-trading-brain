...
| 2026-08-06 | **Governance B1**: campaign cards now require research question, hypothesis, success/rejection criteria, statistical validation, benchmark comparison, and decision categories (ACCEPTED \| REJECTED \| INCONCLUSIVE \| REQUIRES_MORE_DATA, mapped to Edge DB verdicts) | no card stated explicit accept/reject rules; verdicts were reproducible only by convention |
